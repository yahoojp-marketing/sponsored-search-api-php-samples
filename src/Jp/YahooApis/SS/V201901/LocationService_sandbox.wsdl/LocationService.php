...
class LocationService extends \Jp\YahooApis\SS\AdApiSample\Util\Service
{
    ...
    private static $classmap = array (
      ...
      'get' => 'Jp\\YahooApis\\SS\\V201901\\LocationService_sandbox.wsdl\\get',
      'LocationReturnValue' => 'Jp\\YahooApis\\SS\\V201901\\LocationService_sandbox.wsdl\\LocationReturnValue',
      'getResponse' => 'Jp\\YahooApis\\SS\\V201901\\LocationService_sandbox.wsdl\\getResponse',
    );
    ...
    public function __construct($wsdl = null, $endpoint = null, array $options = array())
    {
      ...
      if (!$wsdl) {
        $wsdl = 'https://ss.yahooapis.jp/services/V201901/LocationService_sandbox?wsdl';
      }
