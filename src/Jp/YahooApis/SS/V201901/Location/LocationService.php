...
class LocationService extends \Jp\YahooApis\SS\AdApiSample\Util\Service
{
    ...
    private static $classmap = array (
      ...
      'get' => 'Jp\\YahooApis\\SS\\V201901\\Location\\get',
      'LocationReturnValue' => 'Jp\\YahooApis\\SS\\V201901\\Location\\LocationReturnValue',
      'getResponse' => 'Jp\\YahooApis\\SS\\V201901\\Location\\getResponse',
    );
    ...
    public function __construct($wsdl = null, $endpoint = null, array $options = array())
    {
      ...
      if (!$wsdl) {
        $wsdl = 'https://ss.yahooapis.jp/services/V201901/LocationService?wsdl';
      }
