...
class AuditLogJob
{
     ...
     */
    public function __construct(array $eventSelector)
    {
    ...
    /**
     * @param int $accountId
     * @return \Jp\YahooApis\SS\V201909\AuditLog\AuditLogJob
     */
     ...
     * @return \Jp\YahooApis\SS\V201909\AuditLog\AuditLogJob
     */
    public function setEventSelector(array $eventSelector)
    {
      $this->eventSelector = $eventSelector;
      return $this;
    }
