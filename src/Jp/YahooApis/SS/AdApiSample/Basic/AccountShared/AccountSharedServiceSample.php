...
use Jp\YahooApis\SS\V201901\AccountShared\{AccountShared, AccountSharedOperation, AccountSharedSelector, AccountSharedService, get, getResponse, mutate, mutateResponse, Operator};
