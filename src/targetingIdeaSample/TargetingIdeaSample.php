...
$getTargetingIdeaRequest['selector']['searchParameter'][0] = new SoapVar($getTargetingIdeaRequest['selector']['searchParameter'][0], SOAP_ENC_OBJECT, 'RelatedToKeywordSearchParameter', API_NS, 'searchParameter', XMLSCHEMANS);
